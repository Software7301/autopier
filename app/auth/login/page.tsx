...
import { signInWithGoogle, signInWithDiscord, getSession } from '@/lib/auth-client'
...
function LoginContent() {
  ...
  async function handleDiscordLogin() {
    ...
    try {
      ...
      console.error('Erro ao fazer login:', err)
      setError(err.message || 'Erro ao fazer login com Discord')
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-display font-bold text-white mb-2">
            Bem-vindo à <span className="text-gradient">Takahashi</span>
          </h1>
        ...
        <div className="text-center">
          <p className="text-text-muted text-sm">
            Precisa de ajuda?{' '}
            <a href="mailto:contato@takahashi.com" className="text-primary hover:underline">
              Entre em contato
            </a>
          </p>
        </div>
